...
var TUCJSONProtocol = exports.TUCJSONProtocol = function(trans) {
  this.trans = trans;
};

TUCJSONProtocol.Type = {};
TUCJSONProtocol.Type[Thrift.Type.BOOL] = '"tf"';
TUCJSONProtocol.Type[Thrift.Type.BYTE] = '"i8"';
TUCJSONProtocol.Type[Thrift.Type.I16] = '"i16"';
TUCJSONProtocol.Type[Thrift.Type.I32] = '"i32"';
TUCJSONProtocol.Type[Thrift.Type.I64] = '"i64"';
TUCJSONProtocol.Type[Thrift.Type.DOUBLE] = '"dbl"';
TUCJSONProtocol.Type[Thrift.Type.STRUCT] = '"rec"';
TUCJSONProtocol.Type[Thrift.Type.STRING] = '"str"';
TUCJSONProtocol.Type[Thrift.Type.MAP] = '"map"';
TUCJSONProtocol.Type[Thrift.Type.LIST] = '"lst"';
TUCJSONProtocol.Type[Thrift.Type.SET] = '"set"';


TUCJSONProtocol.RType = {};
TUCJSONProtocol.RType.tf = Thrift.Type.BOOL;
TUCJSONProtocol.RType.i8 = Thrift.Type.BYTE;
TUCJSONProtocol.RType.i16 = Thrift.Type.I16;
TUCJSONProtocol.RType.i32 = Thrift.Type.I32;
TUCJSONProtocol.RType.i64 = Thrift.Type.I64;
TUCJSONProtocol.RType.dbl = Thrift.Type.DOUBLE;
TUCJSONProtocol.RType.rec = Thrift.Type.STRUCT;
TUCJSONProtocol.RType.str = Thrift.Type.STRING;
TUCJSONProtocol.RType.map = Thrift.Type.MAP;
TUCJSONProtocol.RType.lst = Thrift.Type.LIST;
TUCJSONProtocol.RType.set = Thrift.Type.SET;

TUCJSONProtocol.Version = 1;

TUCJSONProtocol.prototype.flush = function() {
  return this.trans.flush();
};

TUCJSONProtocol.prototype.writeMessageBegin = function(name, messageType, seqid) {
  this.tstack = [];
  this.tpos = [];
  this.tstack.push([]);
  //this.tstack.push([TUCJSONProtocol.Version, '"' + name + '"', messageType, seqid]);
};

TUCJSONProtocol.prototype.writeMessageEnd = function() {
  var obj = this.tstack.pop();
  this.wbuf = obj.substr(obj.indexOf(':')+1);
  this.trans.write(this.wbuf);
};

TUCJSONProtocol.prototype.writeStructBegin = function(name) {
  this.tpos.push(this.tstack.length);
  this.tstack.push({});
};

TUCJSONProtocol.prototype.writeStructEnd = function() {
  var p = this.tpos.pop();
  var struct = this.tstack[p];
  var str = '{';
  var first = true;
...
TUCJSONProtocol.prototype.writeFieldBegin = function(name, fieldType, fieldId) {
  this.tpos.push(this.tstack.length);
  this.tstack.push({ 'fieldId': '"' +
    fieldId + '"', 'fieldType': TUCJSONProtocol.Type[fieldType],'name':'"' +name +'"'
  });
};

TUCJSONProtocol.prototype.writeFieldEnd = function() {
  var value = this.tstack.pop();
  var fieldInfo = this.tstack.pop();
  if (':' + value === ":[object Object]") {
    this.tstack[this.tstack.length - 1][fieldInfo.name] = JSON.stringify(value) ;
  } else {
    this.tstack[this.tstack.length - 1][fieldInfo.name] = value ;    
  }
  this.tpos.pop();
};

TUCJSONProtocol.prototype.writeFieldStop = function() {
};

TUCJSONProtocol.prototype.writeMapBegin = function(ktype, vtype, size) {
  //size is invalid, we'll set it on end.
  this.tpos.push(this.tstack.length);
  this.tstack.push([TUCJSONProtocol.Type[ktype], TUCJSONProtocol.Type[vtype], 0]);
};

TUCJSONProtocol.prototype.writeMapEnd = function() {
  var p = this.tpos.pop();
...
TUCJSONProtocol.prototype.writeListBegin = function(etype, size) {
  this.tpos.push(this.tstack.length);
  this.tstack.push([]);
//  this.tstack.push([TUCJSONProtocol.Type[etype], size]);
};

TUCJSONProtocol.prototype.writeListEnd = function() {
  var p = this.tpos.pop();
...
TUCJSONProtocol.prototype.writeSetBegin = function(etype, size) {
    this.tpos.push(this.tstack.length);
    this.tstack.push([TUCJSONProtocol.Type[etype], size]);
};

TUCJSONProtocol.prototype.writeSetEnd = function() {
  var p = this.tpos.pop();
...
TUCJSONProtocol.prototype.writeBool = function(bool) {
  this.tstack.push(bool ? 1 : 0);
};

TUCJSONProtocol.prototype.writeByte = function(byte) {
  this.tstack.push(byte);
};

TUCJSONProtocol.prototype.writeI16 = function(i16) {
  this.tstack.push(i16);
};

TUCJSONProtocol.prototype.writeI32 = function(i32) {
  this.tstack.push(i32);
};

TUCJSONProtocol.prototype.writeI64 = function(i64) {
  this.tstack.push(i64);
};

TUCJSONProtocol.prototype.writeDouble = function(dub) {
  this.tstack.push(dub);
};

TUCJSONProtocol.prototype.writeString = function(str) {
  // We do not encode uri components for wire transfer:
  if (str === null) {
      this.tstack.push(null);
  } else {
      ...
      for (var i = 0; i < str.length; i++) {
          ...
          if (ch === '\"') {
              ...
              escapedString += '\\\\'; // write out as: \\
          /* Currently escaped forward slashes break TUCJSONProtocol.
           * As it stands, we can simply pass forward slashes into
           * our strings across the wire without being escaped.
           * I think this is the protocol's bug, not thrift.js
           * } else if(ch === '/') {   // a single forward slash: /
...
TUCJSONProtocol.prototype.writeBinary = function(arg) {
  this.writeString(arg);
};

TUCJSONProtocol.prototype.readMessageBegin = function() {
  this.rstack = [];
  this.rpos = [];
  ...
  //Verify the protocol version
  var version = this.robj.shift();
  if (version != TUCJSONProtocol.Version) {
    throw 'Wrong thrift protocol version: ' + version;
  }
...
TUCJSONProtocol.prototype.readMessageEnd = function() {
};

TUCJSONProtocol.prototype.readStructBegin = function() {
  var r = {};
  r.fname = '';
...
TUCJSONProtocol.prototype.readStructEnd = function() {
  this.rstack.pop();
};

TUCJSONProtocol.prototype.readFieldBegin = function() {
  var r = {};
  ...
  if (fid != -1) {
    ...
    //way to match a key
    for (var i in (this.rstack[this.rstack.length - 1])) {
      if (TUCJSONProtocol.RType[i] === null) {
        continue;
      }

      ftype = TUCJSONProtocol.RType[i];
      this.rstack[this.rstack.length - 1] = this.rstack[this.rstack.length - 1][i];
    }
  }
...
TUCJSONProtocol.prototype.readFieldEnd = function() {
  var pos = this.rpos.pop();
...
TUCJSONProtocol.prototype.readMapBegin = function() {
  var map = this.rstack.pop();

  var r = {};
  r.ktype = TUCJSONProtocol.RType[map.shift()];
  r.vtype = TUCJSONProtocol.RType[map.shift()];
  r.size = map.shift();
...
TUCJSONProtocol.prototype.readMapEnd = function() {
  this.readFieldEnd();
};

TUCJSONProtocol.prototype.readListBegin = function() {
  var list = this.rstack[this.rstack.length - 1];

  var r = {};
  r.etype = TUCJSONProtocol.RType[list.shift()];
  r.size = list.shift();
...
TUCJSONProtocol.prototype.readListEnd = function() {
  this.readFieldEnd();
};

TUCJSONProtocol.prototype.readSetBegin = function() {
  return this.readListBegin();
};

TUCJSONProtocol.prototype.readSetEnd = function() {
  return this.readListEnd();
};

TUCJSONProtocol.prototype.readBool = function() {
  var r = this.readI32();
...
TUCJSONProtocol.prototype.readByte = function() {
  return this.readI32();
};

TUCJSONProtocol.prototype.readI16 = function() {
  return this.readI32();
};

TUCJSONProtocol.prototype.readI32 = function(f) {
  if (f === undefined) {
    f = this.rstack[this.rstack.length - 1];
  }
...
TUCJSONProtocol.prototype.readI64 = function() {
  return new Int64(this.readI32());
};

TUCJSONProtocol.prototype.readDouble = function() {
  return this.readI32();
};

TUCJSONProtocol.prototype.readBinary = function() {
  return this.readString();
};

TUCJSONProtocol.prototype.readString = function() {
  var r = this.readI32();
  return r;
};

TUCJSONProtocol.prototype.getTransport = function() {
  return this.trans;
};

//Method to arbitrarily skip over data.
TUCJSONProtocol.prototype.skip = function(type) {
  throw 'skip not supported yet';
};
